...
# Rscript dp_global/scripts/main_cpp_chunk.R --DP_MAX_STATES=500 --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=16 --WRITE_DP_FEATHER=FALSE --WRITE_DP_PDF=TRUE --POSTERIOR_SAMPLES=250 --DP_FALLBACK_GROWTH_FORMS="fig"
