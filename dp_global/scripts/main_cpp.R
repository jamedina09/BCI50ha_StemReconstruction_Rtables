...
# Rscript dp_global/scripts/main_cpp.R --WHICH_TAG=249573 --POSTERIOR_SAMPLES=20 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE  --WHICH_TAG=031364
