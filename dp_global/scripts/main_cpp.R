...
# Rscript dp_global/scripts/main_cpp.R --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=TRUE --SENSITIVITY_MODE=run+write+pdf --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE --WHICH_TAG=2747 --RUN_ALL_TAGS=FALSE
# Rscript dp_global/scripts/main_cpp.R --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=TRUE --SENSITIVITY_MODE=run+write+pdf --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE --WHICH_TAG=2747 --RUN_ALL_TAGS=FALSE --DP_FALLBACK_GROWTH_FORMS="fig,tree"
# Rscript dp_global/scripts/main_cpp.R --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=TRUE --SENSITIVITY_MODE=run+write+pdf --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE --WHICH_TAG=2747 --RUN_ALL_TAGS=FALSE --DP_FALLBACK_GROWTH_FORMS="tree"
...
# Rscript dp_global/scripts/main_cpp.R --DP_MAX_STATES=500L --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=TRUE --SENSITIVITY_MODE=run+write+pdf --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE --WHICH_TAG=2747 --RUN_ALL_TAGS=FALSE --DP_FALLBACK_GROWTH_FORMS="fig"

# Rscript dp_global/scripts/main_cpp.R --DP_MAX_STATES=500L --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=NONE --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=16 --WRITE_DP_PDF=TRUE --RUN_ALL_TAGS=TRUE --DP_FALLBACK_GROWTH_FORMS="fig"

# Rscript dp_global/scripts/main_cpp.R --WHICH_TAG=249573 --POSTERIOR_SAMPLES=20 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE  --WHICH_TAG=159367  --DP_FALLBACK_GROWTH_FORMS="fig"

# Rscript dp_global/scripts/main_cpp.R --WHICH_TAG=527220 --POSTERIOR_SAMPLES=20 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE  --WHICH_TAG=527220  --DP_FALLBACK_GROWTH_FORMS="fig"
