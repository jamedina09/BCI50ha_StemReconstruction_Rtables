...
# Rscript dp_global/scripts/main_cpp.R --DP_MAX_STATES=500L --POSTERIOR_SAMPLES=10 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=15 --WRITE_DP_PDF=TRUE --RUN_ALL_TAGS=TRUE --USE_MEASUREMENT_ERROR=TRUE --DP_FALLBACK_GROWTH_FORMS="fig"