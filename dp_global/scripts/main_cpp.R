...
# Rscript dp_global/scripts/main_cpp.R --WHICH_TAG=249573 --POSTERIOR_SAMPLES=20 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=1 --WRITE_DP_PDF=TRUE

# Rscript dp_global/scripts/main_cpp.R --DP_MAX_STATES=500 --POSTERIOR_SAMPLES=20 --POSTERIOR_SAMPLES_FORMAT=csv --POSTERIOR_SAMPLE_SEED=123 --RUN_REALISM_REPORT=FALSE --SENSITIVITY_MODE=none --MANUAL_CORES=TRUE --MANUAL_CORES_VALUE=15 --WRITE_DP_PDF=TRUE --RUN_ALL_TAGS=FALSE --WHICH_TAG=040831
